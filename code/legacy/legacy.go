...
func (h *LegacyHasher) ReadFile(r io.Reader) error {
...
func (h *LegacyHasher) AddSha1Hex(s string) error {
...
func (h LegacyHasher) Hex() string {
	return hex.EncodeToString(h.Sum())
}

func New() hasher.FileCollectionHasher {
	return &LegacyHasher{
